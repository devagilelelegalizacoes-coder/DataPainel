...
from app.credits import contar_pendentes_manuais
...
def get_fila_pendentes(user: dict) -> int:
    if user["is_operador"] or user["is_admin"]:
        return contar_pendentes_manuais()
    return 0


templates.env.globals["get_fila_pendentes"] = get_fila_pendentes
